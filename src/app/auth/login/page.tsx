...
const Login = (props: Props) => {
  return (
    <div className="flex flex-col w-full min-h-screen h-fit bg-base-300 md:bg-base-100 ">
      <div className="md:w-2/3 rounded-3xl flex flex-col md:bg-base-300 mx-auto md:py-24 gap-10 my-auto lg:py-44 max-w-screen w-full ">
        <div className="mx-auto md:w-2/3 flex flex-col gap-3">
